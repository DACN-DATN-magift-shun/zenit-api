    ...
    public class SqlHelper
    {
        public static string UpsertDailyStatisticsWithAddedTransactions()
        {
            return @"
                ...
                VALUES (@CategoryStatsId, @Date::date, @TotalAmount, 0.0, 0.0, @CategoryId, (SELECT ""Id"" FROM CategoryGroupId), @AccountId, @CreatedById, NOW(), false)
        ...
        public static string UpsertDailyStatisticsWithDeletedTransactions()
        {
            return @"
                /* CategoryGroupDailyStatistics */
                UPDATE zenit_statistics_dev.""CategoryGroupDailyStatistics""
                ...
                /* CategoryDailyStatistics */
                UPDATE zenit_statistics_dev.""CategoryDailyStatistics""
                SET ""TotalAmount"" = ""TotalAmount"" - @TotalAmount,
                    ""LastModifiedAt"" = NOW(),
                    ""ModifiedById"" = @ModifiedById
                WHERE ""Date"" = @Date::date 
