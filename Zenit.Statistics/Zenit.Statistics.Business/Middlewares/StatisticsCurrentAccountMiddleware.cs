...
namespace Zenit.Statistics.Business.Middlewares
{
    public class StatisticsCurrentAccountMiddleware(
        RequestDelegate next
    ) : CurrentAccountMiddlewareBase<StatisticsCurrentAccount>(next)
    {
        public override async Task InvokeAsync(HttpContext context, StatisticsCurrentAccount currentAccount)
        {
