...
namespace Zenit.Statistics.Migrator.Migrations
{
    ...
    public partial class InitialCreation : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // migrationBuilder.CreateTable(
            //     name: "CategoryGroupMonthlyStatistics",
            //     columns: table => new
            //     {
            //         Id = table.Column<Guid>(type: "uuid", nullable: false),
            //         Date = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            //     constraints: table =>
            //     {
            //         table.PrimaryKey("PK_CategoryGroupMonthlyStatistics", x => x.Id);
            //     });

            // migrationBuilder.CreateTable(
            //     name: "CategoryGroupWeeklyStatistics",
            //     columns: table => new
            //     {
            //         Id = table.Column<Guid>(type: "uuid", nullable: false),
            //         Date = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            //     constraints: table =>
            //     {
            //         table.PrimaryKey("PK_CategoryGroupWeeklyStatistics", x => x.Id);
            //     });

            // migrationBuilder.CreateTable(
            //     name: "CategoryMonthlyStatistics",
            //     columns: table => new
            //     {
            //         Id = table.Column<Guid>(type: "uuid", nullable: false),
            //         Date = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            //     constraints: table =>
            //     {
            //         table.PrimaryKey("PK_CategoryMonthlyStatistics", x => x.Id);
            //     });

            // migrationBuilder.CreateTable(
            //     name: "CategoryWeeklyStatistics",
            //     columns: table => new
            //     {
            //         Id = table.Column<Guid>(type: "uuid", nullable: false),
            //         Date = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            //     constraints: table =>
            //     {
            //         table.PrimaryKey("PK_CategoryWeeklyStatistics", x => x.Id);
            //     });
